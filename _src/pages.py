  ...
  <div class="wrap">
    ...
    <div class="vision-body reveal reveal-d1">
      <div class="vision-block">
        <h3>Our vision</h3>
        <p>To be a hub of Professional Excellency through continued innovations in science, governance, research and entrepreneurship for Nations in the East African region and beyond.</p>
      </div>
      <div class="vision-block">
        <h3>Our mission</h3>
        <p>To provide transformative education experience for students, with intent to foster productive careers, meaningful livelihood, and responsible citizenry in a global society.</p>
      </div>
      <div class="vision-block">
        <h3>Where we are</h3>
...
<!-- The university's own four values, from the 15th Graduation ceremony
     book (28 November 2025). The four that stood here before were written for
     this page and were never the university's. -->
<ul class="bullets">
  <li><strong>Professionalism.</strong></li>
  <li><strong>Innovation.</strong></li>
  <li><strong>Integrity.</strong></li>
  <li><strong>Excellency.</strong></li>
</ul>

<h2 id="leadership">Leadership</h2>
<!-- Office holders as printed in the university's 15th Graduation ceremony
     book, 28 November 2025. Photographs are still to be supplied. -->
<p>The University is led by its Chancellor and Vice Chancellor, under a Council
chaired independently of the administration.</p>
<div class="table-wrap">
<table class="tbl">
  <thead><tr><th>Office</th><th>Holder</th></tr></thead>
  <tbody>
    <tr><td>Chancellor</td><td>Prof. Tarsis Kabwegyere</td></tr>
    <tr><td>Chairperson, University Council</td><td>His Eminence the Most Rev. Dr. Leonard Lubega</td></tr>
    <tr><td>Vice Chairperson, University Council</td><td>Dr. Tashobya Christine</td></tr>
    <tr><td>Vice Chancellor</td><td>Prof. A. J. Lutalo-Bosa</td></tr>
    <tr><td>Deputy Vice Chancellor (Finance &amp; Administration)</td><td>Dr. Etoru Martin</td></tr>
    <tr><td>Deputy Vice Chancellor (Academic Affairs)</td><td>Dr. Sekabira Kassim</td></tr>
    <tr><td>University Secretary</td><td>Ms. Kyokunda Evelyn Hope</td></tr>
    <tr><td>Academic Registrar</td><td>Dr. Ssegawa E. James Kiggundu</td></tr>
    <tr><td>Director, Quality Assurance</td><td>Dr. Nwanna Uchechukwu Kevin</td></tr>
    <tr><td>Director, External and Distance Learning</td><td>Mr. Ochwo Richard</td></tr>
    <tr><td>Dean of Students</td><td>Ms. Ellen Katushabe Kinuge</td></tr>
  </tbody>
</table>
</div>
<p class="muted">Deans, deputy registrars and the full list of principal
officers are published in the University's graduation programme.</p>
...
NEWS = page_body(
    ...
    """<h2>Latest</h2>
<!-- The first two items come from the University's own 15th Graduation
     ceremony book, 28 November 2025. Everything stated in them is printed
     there; nothing has been added. Photographs of the Alumni Association
     launch and of the Juba campus are still to be supplied. -->

<div class="news-list">
  <article class="news-item">
    <picture>
      <source type="image/webp" srcset="img/graduation-1-640.webp">
      <img src="img/graduation-1-640.jpg" alt="Graduands at Team University" width="640" height="683" loading="lazy">
    </picture>
    <div>
      <p class="news-date">Silver Jubilee &middot; 21 November 2025</p>
      <h3>Twenty-five years, and the university&rsquo;s first Alumni Association</h3>
      <p>Team University marked twenty-five years of transformative education with
         the launch of its first-ever Alumni Association on 21 November 2025. The
         keynote was delivered by Ms. Grace Ruto Cherotich, Vice Chairperson of the
         Makerere University Convocation, whose message to graduates was
         &ldquo;Reconnect. Celebrate. Transform.&rdquo;</p>
      <p>The Association is led in the interim by Ms. Nakimuli Hanifah. It sets out
         to strengthen the University&rsquo;s visibility and reach, to build mentorship
         and career development for graduates, to open research and innovation
         partnerships, and to mobilise alumni behind the Silver Jubilee&rsquo;s flagship
         project &mdash; the construction of the Silver Jubilee House.</p>
      <p>More than a building, the House is intended as a home for alumni
         engagement: a hub for innovation, and a legacy of the tens of thousands of
         graduates who have passed through the University&rsquo;s halls over
         twenty-five years.</p>
    </div>
  </article>
  ...
  <article class="news-item">
    <picture>
      ...
      <img src="img/campus-group-640.jpg" alt="Graduands at Team University" width="640" height="360" loading="lazy">
    </picture>
    <div>
      <p class="news-date">Partnerships &middot; Juba, South Sudan</p>
      <h3>Studying with Team University in South Sudan</h3>
      <p>Destiny University College in Juba runs programmes in collaboration with
         Team University, taking students at certificate, diploma and bachelor&rsquo;s
         level on the day, evening, weekend and distance schedules &mdash; the same
         four ways of studying offered in Kampala.</p>
      <p>Destiny University College is a private institution registered and
         accredited by the Ministry of Higher Education, Science and Technology in
         the Republic of South Sudan, with intakes in February and August. Students
         in South Sudan can ask about the collaboration at
         <a href="mailto:info@destinyuniversity.ss">info@destinyuniversity.ss</a>,
         or <a href="contact.html">contact the Kampala campus</a>.</p>
    </div>
  </article>
  <article class="news-item">
    <picture>
